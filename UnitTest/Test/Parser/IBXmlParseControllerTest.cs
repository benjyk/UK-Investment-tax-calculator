...
{
    private readonly string _taxExampleXml = File.ReadAllText(Path.Combine("Test", "resource", "TaxExample.xml"));
    private readonly string _invalidFileXml = File.ReadAllText(Path.Combine("Test", "resource", "InvalidFile.xml"));
